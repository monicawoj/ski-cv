  ...
  sections: [
    {
      ...
      title: "Profile",
      content:
        "Frontend Developer, Blogger, Speaker, Adventurer. Lifelong learner and fan of simplicity. Dual US / Polish citizen.",
      icon: "usertie",
    },
    {
      type: "common-list",
      ...
      items: [
        {
          ...
          company: "Netguru",
          description:
            "custom software development for European and US clients",
          companyWebSite: "https://www.netguru.com/",
          companyMeta: "",
          datesBetween: "2018 - Present",
        },
        {
          title: "Trip Guide",
          company: "SnowShow",
          description:
            "responsible for leading large group ski/snowboard trips to the Alps",
          companyWebSite: "https://www.snowshow.pl/",
          companyMeta: "",
          datesBetween: "Winter 2019/2020 - Present",
        },
        {
        ...
        },
        {
          ...
          company: "Mastercard",
          description:
            "Go-to-market strategy, lead generation, and thought leadership",
    ...
    },
    {
      ...
      description:
        "My heart belongs to the mountains, lakes, and oceans that cover this beautiful world (and all fields, valleys, and dance floors in between)...",
      icon: "cubes",
      items: [
        "Hiking",
        "Skiing",
      ...
      items: [
        {
          title: "NordicJS 2019",
          authority:
            "Hooked on D3: Creating Animated Charts with D3 and React Hooks",
        ...
        },
        {
          title: "GrillJS 2019",
          authority:
            "The Art of Storythinking: Compelling Storytelling and Critical Thinking",
    ...
    },
    {
      ...
      description:
        "My mind belongs to deep conversations and translation: from idea to code, from data to art, from Polish to English...",
      icon: "rocket",
      items: [
        "React",
        "Javascript",
